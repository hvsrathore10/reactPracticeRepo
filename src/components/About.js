...
export default function About(props) {
    ...
    return (
        <div className="container my-3">
            <h1 className="mb-4" style={{color: props.mode ==='dark'?'white':'#042743'}} >{props.aboutText}</h1>
            <div className="accordion" id="accordionExample">
                <div className={`accordion-item text-${props.mode==='light' ? '#042743' : 'white'} bg-${props.mode} `}>
